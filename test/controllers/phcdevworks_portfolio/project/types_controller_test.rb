...
module PhcdevworksPortfolio
  class Project::TypesControllerTest < ActionDispatch::IntegrationTest
    ...
    test "should create project_type" do
      assert_difference('Project::Type.count') do
        post project_types_url, params: { project_type: { project_type_name: @project_type.project_type_name } }
      end

      assert_redirected_to project_type_url(Project::Type.last)
    end
    ...
    test "should update project_type" do
      patch project_type_url(@project_type), params: { project_type: { project_type_name: @project_type.project_type_name } }
