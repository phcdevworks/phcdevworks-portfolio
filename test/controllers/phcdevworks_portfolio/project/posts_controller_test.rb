  ...
  class Project::PostsControllerTest < ActionDispatch::IntegrationTest
    ...
    test "should create project_post" do
      assert_difference('Project::Post.count') do
        post project_posts_url, params: { project_post: { project_post_description: @project_post.project_post_description, project_post_image: @project_post.project_post_image, project_post_images: @project_post.project_post_images, project_post_status: @project_post.project_post_status, project_post_title: @project_post.project_post_title, project_post_type: @project_post.project_post_type, project_post_url: @project_post.project_post_url } }
      end
    ...
    test "should update project_post" do
      patch project_post_url(@project_post), params: { project_post: { project_post_description: @project_post.project_post_description, project_post_image: @project_post.project_post_image, project_post_images: @project_post.project_post_images, project_post_status: @project_post.project_post_status, project_post_title: @project_post.project_post_title, project_post_type: @project_post.project_post_type, project_post_url: @project_post.project_post_url } }
