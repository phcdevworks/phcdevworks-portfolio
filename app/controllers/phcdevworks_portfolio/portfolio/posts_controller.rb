...
module PhcdevworksPortfolio
  class Project::PostsController < ApplicationController
    ...
    @project_post = Project::Post.new(project_post_params)
      ...
      respond_to do |format|
        if @project_post.save
          format.html { redirect_to portfolio_posts_path, :flash => { :success => 'Portfolio Post has been Added.' }}
    ...
    def update
      respond_to do |format|
        if @project_post.update(project_post_params)
          format.html { redirect_to portfolio_posts_path, :flash => { :notice => 'Portfolio Post has been Updated.' }}
    ...
    def destroy
      ...
      respond_to do |format|
        format.html { redirect_to portfolio_posts_path, :flash => { :error => 'Portfolio Post has been Removed.' }}
